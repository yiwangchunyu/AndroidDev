...
public class PicUrlsDemo extends BaseBean {
    // 中等质量图片url前缀
    private static final String BMIDDLE_URL = UrlConstants.URL_MEDIA_PRE;
    // 原质量图片url前缀
    private static final String ORIGINAL_URL = UrlConstants.URL_MEDIA_PRE;
...
//        return thumbnail_pic.substring(indexOf);
    ...
    public String getThumbnail_pic() {
        return BMIDDLE_URL+thumbnail_pic;
    }
    ...
    public String getOriginal_pic() {
        return TextUtils.isEmpty(original_pic) ? ORIGINAL_URL + getImageId() : ORIGINAL_URL + original_pic;
    }
