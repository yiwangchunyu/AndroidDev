...
public class StatusGridImgsAdapterDemo extends BaseAdapter {
    private Context context;
    private ArrayList<PicUrlsDemo> datas;

    public StatusGridImgsAdapterDemo(Context context, ArrayList<PicUrlsDemo> datas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PicUrlsDemo urls = datas.get(position);
